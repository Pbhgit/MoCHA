...
class DINOVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        self.vision_name = "./models/openai-clip-vit-large-patch14-336"
        self.dinov2_loacal_path = "./models/dinov2_vitl14/facebookresearch_dinov2_main"
        ...
        if not delay_load:
            ...
            self.cfg_only = CLIPVisionConfig.from_pretrained(self.vision_name)
    ...
    def load_model(self):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_name)

        self.clip_vision_tower = CLIPVisionModel.from_pretrained(self.vision_name)

        # self.vision_tower = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitl14')
        self.vision_tower = torch.hub.load(
            self.dinov2_loacal_path, 
            'dinov2_vitl14',
            source='local',
            pretrained=False
            )
        state_dict = torch.load('./models/dinov2_vitl14/checkpoints/dinov2_vitl14_pretrain.pth')
