...
from .vision_models.convnext import convnext_xxlarge, convnext_base
...
class ConvNextVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        # self.freeze_vision = args.get('freeze_vision', True)  # 默认 False
        # self.input_image_size = args.get('input_image_size', None)  # 默认 224
        self.vision_tower_name = vision_tower
        self.vision_name = "/home/xxx/.cache/huggingface/hub/models--timm--convnext_xxlarge.clip_laion2b_soup_ft_in1k"
        # self.vision_name = "convnext_base.clip_laion2b_augreg_ft_in12k_in1k_384"
    ...
    def load_model(self):
        ...
        # if 'base' in self.vision_name:
        #     # self.vision_tower = convnext_xxlarge(pretrained=False)
        #     # from safetensors.torch import load_file
        #     # state_dict = load_file(self.vision_name)
        #     # self.vision_tower.load_state_dict(state_dict)

        #     self.vision_tower = convnext_base(self.vision_tower_name)
        #     print(self.vision_tower)
        #     setattr(self.vision_tower, 'hidden_size', 1024)
        # else:
        #     raise NotImplementedError

        if 'xxlarge' in self.vision_name:
            # self.vision_tower = convnext_xxlarge(pretrained=False)
            # from safetensors.torch import load_file
            # state_dict = load_file(self.vision_name)
            # self.vision_tower.load_state_dict(state_dict)

            self.vision_tower = convnext_xxlarge(self.vision_name)
            # print(self.vision_tower)
