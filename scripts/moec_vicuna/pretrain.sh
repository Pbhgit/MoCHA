...
deepspeed --include localhost:0,1,2,3\
    ...
    --bf16 True \
    --output_dir ./pangyq/checkpoints/llava-vicuna-siglipclipdinoconvnext-moec-attention-token-pretrain \
    --num_train_epochs 1 \
    ...
    --logging_dir ./pangyq/checkpoints/llava-vicuna-siglipclipdinoconvnext-moec-attention-token-pretrain/runs/